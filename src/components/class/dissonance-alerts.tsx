  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Students with conflicting profile traits.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-3">
        ...
        )) : <p className="text-sm text-muted-foreground">No dissonance alerts for this class.</p>}
      </CardContent>
    </Card>
  );
}
